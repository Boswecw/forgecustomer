...
| 9 | Commercial audit | 🟡 | append-only table + enforcement; Stripe, licensing, and lease-issuance writes live, remaining mutation wiring pending |
...
| 21 | Testing | 🟡 | 73 unit + 15 security integration tests; DB-backed e2e suites deferred (see `tests/README.md`) |
